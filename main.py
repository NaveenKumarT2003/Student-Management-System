...
class Student:
    ...
    # ******************* Buttons *********************
        ...
        self.Add.pack()
        self.View =Button(self.Button_Frame, text="View", width=25, font="arial 11 bold")
        self.View.pack()
        ...
        self.tree =ttk.Treeview(self.Frame_2, columns=("c1", "c2", "c3","c4", "c5", "c6",), show='headings',height=50)
        self.tree.pack()
        ...
        self.tree.insert("", index=0, values=(1, "ram", 22, "12-2-2003", "male", "bengaluru"))
        self.tree.pack()
    ...
    def View(self):
        c = sqlite3.connect("Student.db")
        curses = c.cursor()
        curses.execute("SELECT ID, NAME, ADE, DOB, GENDER, CITY FROM STUDENT")
